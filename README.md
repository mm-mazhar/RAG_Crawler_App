# RAG | WEBSITE CRAWLER | A Document Q&A Application with LanceDB
...
Streamlit-based application that enables you to ask questions about documents and receive answers based on the content of those documents. It uses a Retrieval-Augmented Generation (RAG) pipeline to find relevant information within the document and generate accurate, context-aware responses.
